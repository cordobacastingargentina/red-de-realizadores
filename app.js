...
function renderDirectory(){app.innerHTML=`<section class="hero hero-cordoba wrap">
  <div class="hero-copy">
    ...
    <div class="hero-actions">
      <button id="heroExploreBtn" class="primary">Explorar realizadores</button>
      <button id="heroTrainingBtn" class="outline hero-training-btn">Formate como profesional</button>
    </div>
  </div>
  <aside class="hero-visual" aria-label="Comunidad audiovisual de Córdoba">
    <img src="assets/hero-cordoba-filmset.svg" alt="Equipo audiovisual trabajando en un rodaje">
    <div class="hero-brand-panel hero-brand-overlay"><img src="assets/rr-logo.svg" alt="Red de Realizadores"><div class="cc"><span>UNA INICIATIVA DE</span><img src="assets/cordoba-casting-white.png" alt="Córdoba Casting"></div></div>
  </aside>
...
if(heroExplore)heroExplore.onclick=()=>document.querySelector(".search-panel")?.scrollIntoView({behavior:"smooth",block:"start"});
const heroTraining=document.getElementById("heroTrainingBtn");
if(heroTraining)heroTraining.onclick=()=>{location.hash="#formacion"};
draw()}
