...
function renderDirectory(){app.innerHTML=`<section class="hero hero-cordoba wrap">
  <div class="hero-copy">
    ...
    <div class="hero-cc-signature">
      <span>UNA INICIATIVA DE</span>
      <img src="assets/cordoba-casting-white.png" alt="Córdoba Casting">
    </div>
  </div>

  <aside class="hero-photo" aria-label="Rodaje audiovisual">
    <img src="assets/hero-filmset-cordoba.png" alt="Equipo audiovisual trabajando en un rodaje">
