...
async function loadPublicProfilesIntoExistingUI(){
  ...
  profiles=(data||[]).map((p,i)=>{
    ...
    return {
      ...
      scriptPdfUrl:"",
      updated:new Date(p.profile_updated_at).toLocaleDateString("es-AR"),
